...
/**
 *
 * @author Gerson Boche Peralta
 */
public class Calculadore extends javax.swing.JFrame {
    ...
    */
    ...
    public Calculadore() {
        ...
        //Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getResource("src/main/java/imagenes/icono.png"));
        //setIconImage(icon);
    ...
    /*codigo de poner sin sero el resultado*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calculadore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calculadore().setVisible(true);
            }
        });
    }
